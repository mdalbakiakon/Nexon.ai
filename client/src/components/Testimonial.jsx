    ...
    <>
      ...
      `}</style>
        ...
        <div className='text-center mt-60'>
            <h2 className='text-primary text-[28px] sm:text-[36px] lg:text-[42px] font-semibold'>Testimonials</h2>
      ...
      {/* First Row */}
      <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative mt-14">
      ...
      {/* Second Row */}
      <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative mb-60">
        <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none bg-gradient-to-r from-white to-transparent"></div>
