  ...
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <img className="h-12" src={assets.logo} alt="dummyLogoDark" />
            <h2 className='text-primary font-semibold text-xl'>Nexon.ai</h2>
            </div>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © <span className='text-primary font-semibold'>
        <a href="/">Nexon.ai</a>
        </span>
        . All Right Reserved.
    </p>
